...
public class DecemberEventTest {
    ...
    void christmasDdayDiscountTest() {
        ...
        decemberEvent = new DecemberEvent(orders);
    ...
    void weekdayDiscountTest() {
        ...
        Assertions.assertEquals(2023, decemberEvent.calculateWeekdayDiscount(date));
    }
    ...
    void weekendDiscountTest() {
        ...
        decemberEvent = new DecemberEvent(orders);
        LocalDate date = LocalDate.of(2024, 12, 15);
        Assertions.assertEquals(4046, decemberEvent.calculateWeekendDiscount(date));
    }
    ...
    void giveawayTest() {
        ...
        decemberEvent = new DecemberEvent(orders);
        LocalDate date = LocalDate.of(2024, 12, 15);
        Assertions.assertEquals(Map.of("샴페인", "1"), decemberEvent.getGiveaway());
    }
    ...
    void minCostToApplyEventTest() {
        ...
        int weekdayDiscount = decemberEvent.calculateWeekdayDiscount(date);
        int weekendDiscount = decemberEvent.calculateWeekendDiscount(date);
        Map<String, String> giveaway = decemberEvent.getGiveaway();
