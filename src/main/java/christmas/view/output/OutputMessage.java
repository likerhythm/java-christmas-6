...
public class OutputMessage {
    ...
    private static final String NOTICE_EVENT_PREVIEW = "12월 %s일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!";
    ...
    public static String buildNoticeEventPreviewMessage(String visitDate) {
        return String.format(NOTICE_EVENT_PREVIEW, visitDate);
    }
